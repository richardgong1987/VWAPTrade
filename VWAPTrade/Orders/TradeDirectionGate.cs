...
public static class TradeDirectionGate {
    public static bool IsAllowed(TradeDirectionPermissionModel mode, SignalSideModel side) {
        switch (mode) {
            case TradeDirectionPermissionModel.LongOnly:
                return side == SignalSideModel.Buy;
            case TradeDirectionPermissionModel.ShortOnly:
